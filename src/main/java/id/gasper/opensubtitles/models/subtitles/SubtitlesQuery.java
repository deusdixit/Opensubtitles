...
/**
 * SubtitlesQuery is a specialized query builder class that extends the base Query class.
 * It is used to construct and manipulate a query for fetching subtitles based on various criteria.
 * The class provides methods to set filters, options, and conditions related to subtitles queries.
 * Each method modifies the query parameters and returns the updated instance, enabling method chaining.
 */
public class SubtitlesQuery extends Query {
    ...
    public SubtitlesQuery setForeignPartsOnly(Settings s) {
        switch (s) {
            case INCLUDE:
                this.add("foreign_parts_only", "include");
                break;
            case EXCLUDE:
                this.add("foreign_parts_only", "exclude");
                break;
            case ONLY:
                this.add("foreign_parts_only", "only");
                break;
            default:
                break;
        }
    ...
    public SubtitlesQuery setHearingImpaired(Settings s) {
        switch (s) {
            case INCLUDE:
                this.add("hearing_impaired", "include");
                break;
            case EXCLUDE:
                this.add("hearing_impaired", "exclude");
                break;
            case ONLY:
                this.add("hearing_impaired", "only");
                break;
            default:
                break;
        }
    ...
    public SubtitlesQuery setOrderBy(OrderOptions o) {
        switch (o) {
            case AI_TRANSLATED:
                this.add("order_by", "ai_translated");
                break;
            case EPISODE_NUMBER:
                this.add("order_by", "episode_number");
                break;
            case FOREIGN_PARTS_ONLY:
                this.add("order_by", "foreign_parts_only");
                break;
            case HEARING_IMPAIRED:
                this.add("order_by", "hearing_impaired");
                break;
            case ID:
                this.add("order_by", "id");
                break;
            case IMDB_ID:
                this.add("order_by", "imdb_id");
                break;
            case LANGUAGES:
                this.add("order_by", "languages");
                break;
            case MACHINE_TRANSLATED:
                this.add("order_by", "machine_translated");
                break;
            case DOWNLOAD_COUNT:
                this.add("order_by", "download_count");
                break;
            default:
                break;
        }
    ...
    public SubtitlesQuery setOrderDirection(OrderDirection o) {
        switch (o) {
            case ASC:
                this.add("order_direction", "asc");
                break;
            case DESC:
                this.add("order_direction", "desc");
                break;
            default:
                break;
        }
